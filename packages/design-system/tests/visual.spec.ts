...
const CASES: readonly VisualCase[] = [
  { id: 'components-actions-forms-button--default', snapshot: 'button-default.png' },
  { id: 'components-actions-forms-button--bracketed', snapshot: 'button-bracketed.png' },
  { id: 'components-content-card--default', snapshot: 'card-default.png' },
  ...
  { id: 'components-content-badge--emphasis', snapshot: 'badge-emphasis.png' },
  { id: 'foundations-swatch--group', snapshot: 'swatch-group.png' },
  { id: 'components-content-badge--intent', snapshot: 'badge-intent.png' },
  { id: 'components-content-tag--row', snapshot: 'tag-row.png' },
  { id: 'components-content-brackettext--emphasis', snapshot: 'brackettext-emphasis.png' },
  { id: 'components-layout-divider--patterns', snapshot: 'divider-patterns.png' },
  { id: 'components-layout-pagetitle--with-subtitle', snapshot: 'pagetitle-with-subtitle.png' },
  { id: 'components-layout-pageheader--with-children', snapshot: 'pageheader-with-children.png' },
  { id: 'components-content-noteblock--all-types', snapshot: 'noteblock-all-types.png' },
  { id: 'components-content-tldr--default', snapshot: 'tldr-default.png' },
  { id: 'components-overlays-modal--with-footer', snapshot: 'modal-with-footer.png' },
  { id: 'components-overlays-alertdialog--destructive', snapshot: 'alertdialog-destructive.png' },
  { id: 'components-overlays-drawer--from-the-right', snapshot: 'drawer-from-the-right.png' },
  { id: 'components-feedback-toast--all-intents', snapshot: 'toast-all-intents.png' },
  ...
  { id: 'components-layout-appshell--sidebar-open', snapshot: 'appshell-sidebar-open.png' },
  ...
  { id: 'components-overlays-tooltip--on-an-icon-button', snapshot: 'tooltip-on-an-icon-button.png' },
  { id: 'components-overlays-popover--open', snapshot: 'popover-open.png' },
  { id: 'components-overlays-menu--actions', snapshot: 'menu-actions.png' },
  ...
  {
    id: 'components-reports-reportdocument--quality-gate',
    snapshot: 'reportdocument-quality-gate.png',
    fullPage: true,
  },
  { id: 'components-navigation-pagination--middle-page', snapshot: 'pagination-middle-page.png' },
  ...
  { id: 'components-navigation-pagination--as-links-many-pages', snapshot: 'pagination-as-links-many-pages.png' },
  // The general tab set, not the code one: `docs-content-codetabs--merged` below asserts
  // the same tablist wearing `CodeTabs`, and the pair is what shows the
  // extraction rendering identically in both places.
  { id: 'components-navigation-tabs--default', snapshot: 'tabs-default.png' },
  ...
  { id: 'components-navigation-siteheader--portfolio', snapshot: 'siteheader-portfolio.png' },
  ...
  { id: 'components-marketing-hero--default', snapshot: 'hero-default.png' },
  { id: 'components-marketing-featuregrid--default', snapshot: 'featuregrid-default.png', fullPage: true },
  { id: 'components-marketing-pricinggrid--default', snapshot: 'pricinggrid-default.png', fullPage: true },
  { id: 'components-marketing-ctasection--default', snapshot: 'ctasection-default.png' },
  { id: 'components-layout-sectioncontainer--default', snapshot: 'sectioncontainer-default.png' },

  { id: 'docs-layout-breadcrumbs--default', snapshot: 'breadcrumbs-default.png' },
  { id: 'docs-content-codeblock--with-title-and-language', snapshot: 'codeblock-with-title-and-language.png' },
  { id: 'docs-content-codetabs--merged', snapshot: 'codetabs-merged.png' },
  { id: 'docs-content-prose--default', snapshot: 'prose-default.png', fullPage: true },
  { id: 'docs-content-anchorheading--levels', snapshot: 'anchorheading-levels.png' },
  { id: 'docs-layout-tableofcontents--default', snapshot: 'tableofcontents-default.png' },
  { id: 'docs-layout-docpager--both', snapshot: 'docpager-both.png' },
  { id: 'docs-layout-docsheader--with-search', snapshot: 'docsheader-with-search.png' },
  { id: 'docs-layout-docssidebar--default', snapshot: 'docssidebar-default.png' },
  ...
  { id: 'components-content-avatar--default', snapshot: 'avatar-default.png' },
  { id: 'components-actions-forms-input--default-input', snapshot: 'input-default.png' },
  ...
  { id: 'components-actions-forms-checkbox--all-states', snapshot: 'checkbox-all-states.png' },
  { id: 'components-actions-forms-switch--all-states', snapshot: 'switch-all-states.png' },
  ...
  { id: 'components-actions-forms-radiogroup--all-states', snapshot: 'radiogroup-all-states.png' },
  ...
  { id: 'components-actions-forms-select--all-states', snapshot: 'select-all-states.png' },
  { id: 'components-actions-forms-fieldset--all-states', snapshot: 'fieldset-all-states.png' },
  ...
  { id: 'components-data-datatable--sorted-with-caption', snapshot: 'datatable-sorted-with-caption.png' },
  // The pager under a paginated body (issue 276): the table and `Pagination` together.
  { id: 'components-data-datatable--paginated', snapshot: 'datatable-paginated.png' },
  { id: 'foundations-semantic-tokens--roles', snapshot: 'semantic-tokens-roles.png', fullPage: true },
  { id: 'docs-layout-docslayout--default', snapshot: 'docslayout-default.png', fullPage: true },
  ...
  // Chart Primitives
  { id: 'components-data-barchart--vertical', snapshot: 'barchart-vertical.png' },
  { id: 'components-data-sparkline--primary-trend', snapshot: 'sparkline-primary-trend.png' },
  { id: 'components-data-bulletchart--primary-benchmark', snapshot: 'bulletchart-primary-benchmark.png' },
  { id: 'components-data-charttooltip--primary', snapshot: 'charttooltip-primary.png' },
  { id: 'components-icons-socialicon--brand-marks', snapshot: 'socialicon-brand-marks.png' },
  ...
  { id: 'components-feedback-spinner--sizes', snapshot: 'spinner-sizes.png' },
  ...
  { id: 'docs-figures-figureframe--sketch-theme', snapshot: 'figureframe-sketch.png' },
  { id: 'docs-figures-flowdiagram--optimistic-ui', snapshot: 'flowdiagram-optimistic.png' },
  { id: 'docs-figures-flowdiagram--sketch-theme', snapshot: 'flowdiagram-sketch.png' },
  { id: 'docs-figures-timeline--shipped', snapshot: 'timeline-shipped.png' },
  { id: 'docs-figures-timeline--sketch-theme', snapshot: 'timeline-sketch.png' },
  { id: 'docs-figures-changesummary--default', snapshot: 'changesummary-default.png' },
  { id: 'docs-figures-changesummary--sketch-theme', snapshot: 'changesummary-sketch.png' },
  { id: 'docs-figures-beforeafter--default', snapshot: 'beforeafter-default.png' },
  { id: 'docs-figures-beforeafter--sketch-theme', snapshot: 'beforeafter-sketch.png' },
  { id: 'docs-figures-uptimestrip--default', snapshot: 'uptimestrip-default.png' },
  { id: 'docs-figures-uptimestrip--sketch-theme', snapshot: 'uptimestrip-sketch.png' },
  { id: 'docs-figures-treediagram--default', snapshot: 'treediagram-default.png' },
  { id: 'docs-figures-treediagram--sketch-theme', snapshot: 'treediagram-sketch.png' },
  { id: 'docs-figures-activitygrid--blog-posting-cadence', snapshot: 'activitygrid-blog.png' },
  { id: 'docs-figures-activitygrid--sketch-theme', snapshot: 'activitygrid-sketch.png' },
  { id: 'docs-figures-ganttchart--editorial-calendar', snapshot: 'ganttchart-editorial.png' },
  { id: 'docs-figures-ganttchart--sketch-theme', snapshot: 'ganttchart-sketch.png' },
  { id: 'docs-figures-figurecompositions--incident-report', snapshot: 'figurecompositions-incident.png' },
  { id: 'docs-figures-figurecompositions--editorial-plan', snapshot: 'figurecompositions-editorial.png' },
  { id: 'docs-content-terminal--default', snapshot: 'terminal-default.png' },
  { id: 'docs-content-terminal--sketch-theme', snapshot: 'terminal-sketch.png' },
  { id: 'docs-content-steps--default', snapshot: 'steps-default.png' },
  { id: 'docs-content-steps--sketch-theme', snapshot: 'steps-sketch.png' },
];
...
const INTERACTIONS: readonly InteractionCase[] = [
  {
    id: 'components-actions-forms-button--default',
  ...
  {
    id: 'components-actions-forms-input--default-input',
  ...
  {
    id: 'components-actions-forms-select--disabled-option',
...
const MOBILE_CASES: readonly VisualCase[] = [
  ...
  { id: 'components-overlays-drawer--from-the-left', snapshot: 'drawer-from-the-left-mobile.png' },
  ...
  { id: 'components-layout-appshell--default', snapshot: 'appshell-default-mobile.png' },
  {
    id: 'components-layout-appshell--sidebar-open',
  ...
  { id: 'components-navigation-pagination--many-pages', snapshot: 'pagination-many-pages-mobile.png' },
  ...
  {
    id: 'components-overlays-tooltip--at-the-viewport-edge',
    snapshot: 'tooltip-at-the-viewport-edge-mobile.png',
    onScreen: '[data-slot="tooltip"]',
  },
  {
    id: 'components-overlays-popover--at-the-viewport-edge',
    snapshot: 'popover-at-the-viewport-edge-mobile.png',
    onScreen: '[data-slot="popover"]',
  },
  {
    id: 'components-overlays-menu--at-the-viewport-edge',
  ...
  { id: 'components-navigation-siteheader--marketing', snapshot: 'siteheader-marketing-mobile.png' },
  {
    id: 'components-navigation-mobilenav--open',
    snapshot: 'mobilenav-open-mobile.png',
    onScreen: '[data-slot="drawer"]',
  },
  {
    id: 'components-navigation-mobilenav--with-group',
