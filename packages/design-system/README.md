...
`ReportDocument`, `ReportSection` and `ReportDetails` ship from **this** package —
they are ordinary components, and a report composes them like any other. See the
[report generator's README](../ds-report/README.md) for the pipeline.
